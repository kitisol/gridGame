...
export default function BattleSelect() {
  ...
  let svg = (
    <svg viewBox="0 0 160.3 160.3">
      ...
      <g className="left-tine complete">
      ...
      <g className="right-tine incomplete">
        <polygon
          class="outer"
